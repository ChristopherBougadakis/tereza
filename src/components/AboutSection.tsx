        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          >
            {stats.map((s, i) => (
              <div
                key={i}
                className="bg-background border border-border rounded-xl p-6 text-center shadow-card-light"
              >
                <div className="text-3xl md:text-4xl font-extrabold text-gradient-red mb-2">
                  {s.value}
                </div>
